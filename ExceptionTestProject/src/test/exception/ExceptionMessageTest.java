...
public class ExceptionMessageTest {
	...
	/**
	 * Verifies the exception message using the regular exception. This test
	 * verifies that the exception message contains a text "Message" in it.
	 */
	...
	/**
	 * Verifies the exception message based on the exact error message thrown.
	 * This is to show that TestNG fails a test when the exception message does
	 * not match.
	 */
	@Test(expectedExceptions = { IOException.class }, expectedExceptionsMessageRegExp = "Pass Message test")
